...
class CreateCaseMaterial extends Usecase<dynamic, FormData> {
  final InboxRepository _inboxRepository;
  CreateCaseMaterial(this._inboxRepository);
  @override
  Future<Either<dynamic, UIError>> call(FormData params) async {
    try {
      var response = await _inboxRepository.createCaseMaterial(fd: params);
