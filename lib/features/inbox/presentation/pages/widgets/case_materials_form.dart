...
class CaseMaterialForm extends StatefulWidget {
  final int id;
  const CaseMaterialForm({super.key, required this.id});
  @override
  // ignore: library_private_types_in_public_api
  _CaseNoteFormState createState() => _CaseNoteFormState();
}

class _CaseNoteFormState extends State<CaseMaterialForm> {
  ...
  Future<void> onSaved() async {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<InboxCubit>().createMaterial(fd: fd).then((value) {
