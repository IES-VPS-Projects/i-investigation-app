...
abstract class $CaseFileOfficerCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, int? caseFileId, int? userId, String? accepted});
}
...
class _$CaseFileOfficerImpl implements _CaseFileOfficer {
  _$CaseFileOfficerImpl({this.id, this.caseFileId, this.userId, this.accepted});
  ...
  @override
  String toString() {
    return 'CaseFileOfficer(id: $id, caseFileId: $caseFileId, userId: $userId, accepted: $accepted)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, caseFileId, userId, accepted);
...
abstract class _CaseFileOfficer implements CaseFileOfficer {
  factory _CaseFileOfficer(
      ...
      final int? caseFileId,
      final int? userId,
      final String? accepted}) = _$CaseFileOfficerImpl;
