...
CaseMaterial _$CaseMaterialFromJson(Map<String, dynamic> json) {
  return _CaseMaterial.fromJson(json);
}

/// @nodoc
mixin _$CaseMaterial {
  ...
  @JsonKey(ignore: true)
  $CaseMaterialCopyWith<CaseMaterial> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CaseMaterialCopyWith<$Res> {
  factory $CaseMaterialCopyWith(
          CaseMaterial value, $Res Function(CaseMaterial) then) =
      _$CaseMaterialCopyWithImpl<$Res, CaseMaterial>;
  @useResult
  $Res call(
      {int? id,
      int? caseFileId,
...
/// @nodoc
class _$CaseMaterialCopyWithImpl<$Res, $Val extends CaseMaterial>
    implements $CaseMaterialCopyWith<$Res> {
  _$CaseMaterialCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CaseMaterialImplCopyWith<$Res>
    implements $CaseMaterialCopyWith<$Res> {
  factory _$$CaseMaterialImplCopyWith(
          _$CaseMaterialImpl value, $Res Function(_$CaseMaterialImpl) then) =
      __$$CaseMaterialImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$CaseMaterialImplCopyWithImpl<$Res>
    extends _$CaseMaterialCopyWithImpl<$Res, _$CaseMaterialImpl>
    implements _$$CaseMaterialImplCopyWith<$Res> {
  __$$CaseMaterialImplCopyWithImpl(
      _$CaseMaterialImpl _value, $Res Function(_$CaseMaterialImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$CaseMaterialImpl implements _CaseMaterial {
  _$CaseMaterialImpl(
      {this.id,
      this.caseFileId,
      this.title,
  ...
  _$$CaseMaterialImplCopyWith<_$CaseMaterialImpl> get copyWith =>
      __$$CaseMaterialImplCopyWithImpl<_$CaseMaterialImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CaseMaterialImplToJson(
      this,
    );
  }
}
