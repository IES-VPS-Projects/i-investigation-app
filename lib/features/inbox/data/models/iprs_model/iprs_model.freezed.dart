...
IprsModel _$IprsModelFromJson(Map<String, dynamic> json) {
  return _IprsModel.fromJson(json);
}
...
mixin _$IprsModel {
  ...
  @JsonKey(ignore: true)
  $IprsModelCopyWith<IprsModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $IprsModelCopyWith<$Res> {
  factory $IprsModelCopyWith(IprsModel value, $Res Function(IprsModel) then) =
      _$IprsModelCopyWithImpl<$Res, IprsModel>;
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class _$IprsModelCopyWithImpl<$Res, $Val extends IprsModel>
    implements $IprsModelCopyWith<$Res> {
  _$IprsModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$IprsModelImplCopyWith<$Res>
    implements $IprsModelCopyWith<$Res> {
  factory _$$IprsModelImplCopyWith(
          _$IprsModelImpl value, $Res Function(_$IprsModelImpl) then) =
      __$$IprsModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$IprsModelImplCopyWithImpl<$Res>
    extends _$IprsModelCopyWithImpl<$Res, _$IprsModelImpl>
    implements _$$IprsModelImplCopyWith<$Res> {
  __$$IprsModelImplCopyWithImpl(
      _$IprsModelImpl _value, $Res Function(_$IprsModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$IprsModelImpl implements _IprsModel {
  _$IprsModelImpl(
      {this.id,
  ...
  factory _$IprsModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$IprsModelImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$IprsModelImplCopyWith<_$IprsModelImpl> get copyWith =>
      __$$IprsModelImplCopyWithImpl<_$IprsModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$IprsModelImplToJson(
      this,
    );
  }
}

abstract class _IprsModel implements IprsModel {
  factory _IprsModel(
      {final int? id,
      ...
      @JsonKey(name: 'mug_shot') final dynamic mugShot}) = _$IprsModelImpl;

  factory _IprsModel.fromJson(Map<String, dynamic> json) =
      _$IprsModelImpl.fromJson;
